...
Autolabel is a project designed to simplify the auto-labeling of classes in images using the YOLOv model. The provided GUI allows users to choose between a custom YOLOv8 model or Open Dictionary model.
