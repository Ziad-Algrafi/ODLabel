...
def save_yolo_format(detections, labels_dir, image_file):
    ...
    with open(result_txt_path, 'w') as txt_file:
        for cls_id, bbox_x, bbox_y, bbox_width, bbox_height, _, _, img_width, img_height in detections:
...
def save_csv_format(detections, image_file, csv_file_path, csv_headers):
    ...
    with open(csv_file_path, 'a', newline='') as csv_file:
        ...
        for _, bbox_x, bbox_y, bbox_width, bbox_height, label_name, _, img_width, img_height in detections:
            row_data = [
                label_name,
